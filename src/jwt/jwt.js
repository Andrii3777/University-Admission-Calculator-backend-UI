...
class JWT {
    ...
    #createSignature(header, payload, secret) {
        ...
        return this.#base64url(crypto.createHmac('sha256', secret)  // Create HMAC SHA256 signature.
            .update(data)                      // Update HMAC with the data.
            .digest());                       // Finalize and get the digest.
    }
    ...
    sign(payload, secret, options = {}) {
        ...
        const encodedPayload = this.#base64url(Buffer.from(JSON.stringify(payload)));
