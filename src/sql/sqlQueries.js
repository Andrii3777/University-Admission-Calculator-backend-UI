...
const queries = {
  ...
  updateTokenByStudentId:
    "UPDATE refreshToken SET token = ? WHERE studentId = ?",
  ...
  checkIfEmtySpecialtyExamCoefficientTable:
    "SELECT COUNT(*) AS count FROM specialtyExamCoefficient",
};
